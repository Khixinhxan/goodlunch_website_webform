<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="DangKiNguoiDung_Test.aspx.cs" Inherits="Admin_DangKiNguoiDung_Test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table style="width: 600px">
        ...
        <tr>
            ...
            <td style="width: 568px; height: 26px;" align="left">
                <asp:ImageButton ID="btnDangKy" runat="server" ImageUrl="~/images/button_dangky.jpg" OnClick="btnDangKy_Click" />
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Test2ConnectionString %>" SelectCommand="DangKiNguoiDung_Insert" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="textHoTen" Name="HoTen" PropertyName="Text" Type="String" />
                        <asp:ControlParameter ControlID="textTenDangNhap" Name="TenDangNhap" PropertyName="Text" Type="String" />
                        <asp:ControlParameter ControlID="textQuanHuyen" Name="DiaChi" PropertyName="Text" Type="String" />
                        <asp:ControlParameter ControlID="textSoDienThoai" Name="SoDienThoai" PropertyName="Text" Type="String" />
                        <asp:ControlParameter ControlID="textEmail" Name="Email" PropertyName="Text" Type="String" />
                        <asp:ControlParameter ControlID="textMatKhau" Name="MatKhau" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
